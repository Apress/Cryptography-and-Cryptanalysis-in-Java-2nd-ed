...
public class FFSScheme {
	...
	private static BitSet random_b_set;
	...
	private static BitSet random_e_set;
	// the response
	...
	private static void GenerateParameters() {
        ...
        random_b_set = new BitSet(k);
        random_e_set = new BitSet(k);
	}
	...
	private static void GenerateKeys() {
		...
		for (int i = 0; i < k; i++) {
			...
			while (!s_i.gcd(n).equals(BigInteger.ONE)) {
	...
	public static void main(String[] args) {
		...
		random_s_set.forEach(s -> System.out.print(s + " "));
		System.out.print(")");

		System.out.print("\nPublic key: ( ");
		//for (int i = 0; i < k; i++)
		//	System.out.print(computed_v_set.get(i) + " ");
		computed_v_set.forEach(v -> System.out.print(v + " "));
		System.out.print(")");
